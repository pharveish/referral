...
class DoctorBySpecialtyView extends StatelessWidget {
	static route ({user, doctorList, referral}) => MaterialPageRoute(builder: (context)=> DoctorBySpecialtyView (user: user, doctorList:doctorList, referral:referral));
	final user, doctorList, referral;
	DoctorBySpecialtyView ({this.user, this.doctorList, this.referral});
	@override
	Widget build(BuildContext context) {
		return ViewModelBuilder<SpecialtyListViewModel>.reactive(
				viewModelBuilder: ()=> SpecialtyListViewModel(), 
