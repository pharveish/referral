...
import 'package:referral/ui/home/tabviews/referredout/referredout_viewmodel.dart';
import 'package:stacked/stacked.dart';

class ReferredOutView extends StatelessWidget {
	static route ({user}) => MaterialPageRoute(builder: (context)=> ReferredOutView(user: user));
	final user;
	ReferredOutView({this.user});
	@override
	Widget build(BuildContext context) {
		return ViewModelBuilder<ReferredOutViewModel>.reactive(viewModelBuilder: ()=>ReferredOutViewModel(), 
